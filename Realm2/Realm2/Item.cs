...
namespace Realm2
{
    ...
    public class nightbringer : Item
    {
        public nightbringer()
        {
            ...
            atkbuff = 3 + (Program.main.player.level >= 15 ? Program.main.player.level : (int)(Program.main.player.level * 2.5));
            spdbuff = 1 + (Program.main.player.level >= 15 ? Program.main.player.level : (int)(Program.main.player.level * 1.5));
            defbuff = 1 + Program.main.player.level;
            intlbuff = Program.main.player.level;
            slot = 1;
            tier = 7;
            multiplier = 4;
        }
